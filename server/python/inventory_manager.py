...
A small wrapper class that calls the Stripe SDK to manage Products and Orders.
If you manage your Products and SKUs in a different way, you can override these methods.
"""
