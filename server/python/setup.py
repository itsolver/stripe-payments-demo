...
This is a one-time setup script that creates three sample Products and some SKUs for our Stripe store.
You can add these Products in the check out flow to create your Order.
"""
